        ...
        <div className="flex w-full items-center justify-between gap-3 md:w-1/3 md:justify-start min-w-0">
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              {/* Logo con fondo azul #2E6EB0 - mantiene color constante durante scroll */}
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 682 682" className="w-14 h-14 shrink-0 bg-[#2E6EB0] rounded-full overflow-hidden">
